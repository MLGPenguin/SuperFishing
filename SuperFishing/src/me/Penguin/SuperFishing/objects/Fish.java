...
public class Fish {
	...
	public enum FISH {		
		...
		cod3(new Fish(Material.COD, 0.0014042, Catch.MYTHICAL, 150000)),
		...
		salmon3(new Fish(Material.SALMON, 0.0010922, Catch.MYTHICAL, 180000)),
		...
		pufferfish3(new Fish(Material.PUFFERFISH, 0.0003901, Catch.MYTHICAL, 780000)),
		...
		tropicalfish3(new Fish(Material.TROPICAL_FISH, 0.0002808, Catch.MYTHICAL, 1080000)),
		...
		cookedcod3(new Fish(Material.COOKED_COD, 0.0016851, Catch.MYTHICAL, 180000)),
		...
		cookedsalmon3(new Fish(Material.COOKED_SALMON, 0.0012541, Catch.MYTHICAL, 210000)),
		...
		prismarineshard3(new Fish(Material.PRISMARINE_SHARD, 0.0002184, Catch.MYTHICAL, 1500000)),
		...
		prismarinecrystals3(new Fish(Material.PRISMARINE_CRYSTALS, 0.0001061, Catch.MYTHICAL, 3000000)),
		...
		inksac3(new Fish(Material.INK_SAC, 0.0000737, Catch.MYTHICAL, 4500000)),
		scute1(new Fish(Material.SCUTE, 0.0009362, Catch.RARE, 150000)),
		scute2(new Fish(Material.SCUTE, 0.0001989, Catch.EXOTIC, 1200000)),
		scute3(new Fish(Material.SCUTE, 0.0000468, Catch.MYTHICAL, 6000000)),
		nautilusshell2(new Fish(Material.NAUTILUS_SHELL, 0.000011, Catch.EXOTIC, 15000000)),
		nautilusshell3(new Fish(Material.NAUTILUS_SHELL, 0.0000023, Catch.MYTHICAL, 120000000)),
		turtleegg3(new Fish(Material.TURTLE_EGG, 0.0000015, Catch.MYTHICAL, 300000000));
